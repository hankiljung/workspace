...
public interface StudentUtil {
  ...
  //메서드명 : getTotalScore
  int getTotalScore(Student a);

  //매개변수로 들어온 두 학생 중
  //총점이 높은 학생을 리턴
  //메서드명 : getHighScoreStudent

  Student getHighScoreStutdent(Student a, Student b);
	...
	String getGradeByStudentName(Student[] stuArr, Student a);
	...
	int[] getTotalScoresToArray(Student[] stuArr);
